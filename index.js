...
function ready() {
	...
	document.getElementById('imageInput').onchange = function (event) {
		...
		scaledCanvas.title = selectedFile.name;
	...
	processButton.onclick = function(event) {
		...
		var mode = modeMap[imageType.value]
		var size = scaleMap[mode]
		scaledCanvas.width = size[0]
		scaledCanvas.height = size[1]
